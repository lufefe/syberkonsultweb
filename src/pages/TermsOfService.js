    ...
    <>
      ...
      <Section className="overflow-hidden">
        ...
        >
          ...
          <h2 className="h2 mb-2">Acknowledgment</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h2 className="h2 mb-2">Termination</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h2 className="h2 mb-2">Limitation of Liability</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h2 className="h2 mb-2">Governing Law</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h2 className="h2 mb-2">Disputes Resolution</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <h2 className="h2 mb-2">For European Union (EU) Users</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which You are
            resident.
          </p>
          <h2 className="h2 mb-2">United States Legal Compliance</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h2 className="h2 mb-2">Severability and Waiver</h2>
          <h3 className="h3 mb-2">Severability</h3>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h3 className="h3 mb-2">Waiver</h3>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
          ...
          <h2 className="h2 mb-2">Translation Interpretation</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <h2 className="h2 mb-2">Changes to These Terms and Conditions</h2>
          <p className="font-normal text-wrap mb-2 text-lg leading-snug">
